//main-swiper-slide purple_cushion
//const 변수명 = new Swiper(`적용대상`);
//const 변수명 = new Swiper(`적용대상`, {속성:값, 속성:값});
const purple_cushion_slide = new Swiper('#purple_cushion_slide',{
    //자동재생
    autoplay:{
    ...
    navigation: { //이전, 다음 내비게이션 연결
        ...
        nextEl: '#purple_cushion_slide .swiper-button-next',
        prevEl: '#purple_cushion_slide .swiper-button-prev',
    }
    // direction:'vertical'
});

// purple_cushion-slide2
const purple_cushion_slide2 = new Swiper('#purple_cushion_slide2',{
    autoplay:{delay:2000},
    loop:true,
    effect:'fade',
})